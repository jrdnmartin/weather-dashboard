...
import { convertTemperature } from '../page';
    ...
    <div className="flex flex-col items-center w-full">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-5 gap-4 w-full">
        {forecast.map((day, index) => (
          <div key={index} className="bg-white/80 backdrop-blur-lg p-4 rounded-3xl shadow-lg text-center text-gray-800 shadow-lg transition duration-300 hover:scale-105">
